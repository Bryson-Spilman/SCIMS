...
public enum StrongmanCorpWeightClasses {
    ...
    SC_MEN_OPEN(new StrengthWeightClassBuilder().withName("Strongman Corporation MEN OPEN").withMaxCompetitorWeight(Double.MAX_VALUE).withEventsInOrder(new ArrayList<>()).build()),
    ...
    SC_WOMEN_OPEN(new StrengthWeightClassBuilder().withName("Strongman Corporation WOMEN OPEN").withMaxCompetitorWeight(Double.MAX_VALUE).withEventsInOrder(new ArrayList<>()).build());
